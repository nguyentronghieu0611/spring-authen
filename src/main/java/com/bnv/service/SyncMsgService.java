...
public class SyncMsgService {
    ...
    public SyncResponse callStoreProcedureServicem0001(String actiontype, int nhansu_id, JSONObject objheader, JSONObject objthongtinchung, JSONObject objtuyendungquatrinhcongtac, JSONObject objluongphucapchucvu, JSONObject objtrinhdodaotaoboiduong, JSONObject objthongtinkhac,
    ...
    public SyncResponse callStoreProcedureServicem0002(String actiontype, int nhansu_id, JSONObject objheader, JSONObject objtuyendungquatrinhcongtac, JSONArray arrquatrinhcongtac) {
    ...
    public SyncResponse callStoreProcedureServicem0003(String actiontype, int nhansu_id, JSONObject objheader, JSONObject objluongphucapchucvu, JSONArray arrquatrinhphucap, JSONArray arrquatrinhluong) {
    ...
    public SyncResponse callStoreProcedureServicem0004(String actiontype, int nhansu_id, JSONObject objheader, JSONObject objtrinhdodaotaoboiduong, JSONArray arrtinhoc, JSONArray arrngoaingu, JSONArray arrquatrinhdaotaoboiduong) {
    ...
    public SyncResponse callStoreProcedureServicem0005(String actiontype, int nhansu_id, JSONObject objheader, JSONObject objthongtinkhac) {
    ...
    public SyncResponse callStoreProcedureServicem0006(String actiontype, int nhansu_id, JSONObject objheader, JSONArray arrketquadanhgia) {
